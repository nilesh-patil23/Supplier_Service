...
public class SupplierModel {
	...
	@Pattern(regexp = "^[a-zA-Z ]+$", message = "Supplier name should contain alphabets and spaces")
	private String supplierName;

	@NotBlank(message = "City Name Should Not Be Blank")
	@Pattern(regexp = "^[a-zA-Z ]+$", message = "City name should contain alphabets and spaces")
	private String city;
	...
	@NotBlank(message = "Contry Name Should Not Be Blank")
	@Pattern(regexp = "^[a-zA-Z ]+$", message = "Country name should contain alphabets and spaces")
